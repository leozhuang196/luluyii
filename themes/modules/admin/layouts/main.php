    ...
    if (Yii::$app->user->isGuest) {
        ...
        $menuItems = [
            ['label' => '系统配置',
                'url'=>['/admin/config/'],
                'items'=>[
                    ['label'=>'<span class="glyphicon glyphicon-cog"></span> 基本配置','url'=>['/admin/config/basic']],
                    ['label'=>'<span class="glyphicon glyphicon-cog"></span> 主题配置','url'=>['/admin/config/theme']],
                ]
            ],
            ['label' => 'rbac',
                'url'=>['/admin/rbac/'],
                'items'=>[
                    ['label'=>'<span class="glyphicon glyphicon-user"></span> 角色管理','url'=>['/admin/rbac/role']],
                    ['label'=>'<span class="glyphicon glyphicon-user"></span> 权限管理','url'=>['/admin/rbac/permission']],
                ]
            ],
